...
const sectionScheme = new mongoose_1.default.Schema({
    ...
    projects: {
        ...
        projects: [
            {
                title: { type: String, required: true, trim: true, maxlength: 150 },
                resume: { type: String, required: true, trim: true, maxlength: 250 },
                description: { type: String || Number, required: true, trim: true },
                mainLang: { type: String, required: true, trim: true, maxlength: 50 },
                srcImg: { type: String, required: true, trim: true, maxlength: 150 },
                urlDemo: { type: String, required: true, trim: true },
                urlRepository: { type: String, required: true, trim: true },
            }
        ]
    }
});
